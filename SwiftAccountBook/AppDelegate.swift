...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
    var dataController: MyDataController!
...
//        appearance.backgroundColor = Constants.defaultRedColor
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "me.sen.SwiftAccountBook" in the application's documents Application Support directory.
